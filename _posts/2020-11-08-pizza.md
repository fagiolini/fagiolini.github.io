...
> if you store your pizza in the fridge for the next days, before consuming we suggest heating each slice in the microwave for a couple of minutes, and then put it in a pre-heated pan for a couple minutes more. the microwave will make the heating even, the pan will keep the botton crusty!